...
`define DBG_MODULE_UUID _951c341776e3486595418e84d562b23b
...
module edb_top (
    ...
    input  la2_probe9,
    input  la2_probe10,
    input  [7:0] la2_probe11,
    input  [7:0] la2_probe12,
    input  la2_probe13,
    input  la2_probe14,
    input  la2_probe15,
    input  [7:0] la2_probe16,
    input  [7:0] la2_probe17
);
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h14b65ea8483448f1ac8901be2deffcf0 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 )
    ) la0 (
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hfc9da2db408d43fa9c99fa48ec0c634c ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
    ...
    `DBG_MODULE_NAME(edb_la_top) #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h95a3245237dc46a7bc4fbf51ccd10d51 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
